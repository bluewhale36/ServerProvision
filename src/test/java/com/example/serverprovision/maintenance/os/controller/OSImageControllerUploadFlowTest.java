...
import com.example.serverprovision.maintenance.os.exception.InvalidUploadTokenException;
import com.example.serverprovision.maintenance.os.exception.DuplicateFilenameException;
import com.example.serverprovision.maintenance.os.exception.IsoUploadIntentConflictException;
...
class OSImageControllerUploadFlowTest {
    ...
    class Intent {
        ...
        void success() throws Exception {
            ...
            mvc.perform(post("/pxe/v1/maintenance/os/1/iso/upload-intent")
        ...
        void unknownOs_returns404() throws Exception {
            ...
            mvc.perform(post("/pxe/v1/maintenance/os/999/iso/upload-intent")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(om.writeValueAsString(req)))
    ...
    class Upload {
        ...
        void success() throws Exception {
            ...
            mvc.perform(multipart("/pxe/v1/maintenance/os/1/iso/upload")
                            .file(buildFile())
        ...
        void unknownOs_returns404() throws Exception {
            ...
            mvc.perform(multipart("/pxe/v1/maintenance/os/999/iso/upload")
                            .file(buildFile())
                            .param("isoPath", "/mnt/iso/dvd.iso")
                            .param("allowCreateDirectory", "false")
                            .header("X-Upload-Token", "t"))
    ...
    class Extract {
        ...
        void success() throws Exception {
            ...
            mvc.perform(post("/pxe/v1/maintenance/os/1/iso/2/extract"))
                    .andExpect(status().isOk())
        ...
        void unknownIso_returns404() throws Exception {
            ...
            mvc.perform(post("/pxe/v1/maintenance/os/1/iso/99/extract"))
                    .andExpect(status().isNotFound());
        }
    }
}
