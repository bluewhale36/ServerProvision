...
/**
 * Rocky Linux 8.x 계열 {@link OSInstallationBuilder} 구현체이다.
 * {@code osName=ROCKY_LINUX} + {@code osVersion} 이 {@code "8."} 로 시작하는 메타데이터를 처리한다.
 */
@Component
public class RockyLinux8Builder extends AbstractRHELInstallationBuilder {

    public RockyLinux8Builder(
    ...
    public boolean supports(OSInstallationRequest request, OSMetadata osMetadata) {
        return request instanceof RHELInstallationRequest
                ...
                && osMetadata.getOsVersion().startsWith("8.");
    }
    ...
    protected RHELBasedInstallation buildRHELInstallation(
        ...
        return RockyLinux8Installation.builder()
