package com.example.serverprovision.maintenance.board.controller;
...
import com.example.serverprovision.maintenance.board.service.BoardModelService;
 ...
 *   <li>성공 시 {@code /pxe/v1/maintenance/board?selectId=...} 로 리다이렉트해 Miller 초기 선택을 복원한다.</li>
 ...
 */
@Controller
@RequestMapping("/pxe/v1/maintenance/board")
...
public class BoardModelController {
    ...
    public String delete(@PathVariable Long id) {
        ...
        return "redirect:/pxe/v1/maintenance/board";
    }
    ...
    private String redirectToListWithSelect(Long selectId) {
        return "redirect:/pxe/v1/maintenance/board?selectId=" + selectId;
    }
