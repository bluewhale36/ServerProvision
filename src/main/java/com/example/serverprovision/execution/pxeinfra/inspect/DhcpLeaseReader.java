...
/**
 * dnsmasq 임대 파일을 읽어 스냅샷으로 파싱하는 경계 — 영역(DHCP 대시보드)과 컨트롤러(임대 목록 페이지)가
...
public class DhcpLeaseReader {
    ...
    private final DnsmasqLeaseParser parser;

    public DhcpLeaseReader(ObjectProvider<PxeInfraProperties> propertiesProvider, DnsmasqLeaseParser parser) {
