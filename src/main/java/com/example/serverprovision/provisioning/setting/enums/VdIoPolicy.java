 ...
 */
public enum VdIoPolicy {
    DIRECT("direct", "Direct IO"),
    CACHED("cached", "Cached IO");

    public static final VdIoPolicy DEFAULT = DIRECT;

    private final String cliToken;
    private final String displayName;

    VdIoPolicy(String cliToken, String displayName) {
