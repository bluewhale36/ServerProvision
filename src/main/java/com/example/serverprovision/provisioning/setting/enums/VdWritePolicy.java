 ...
 */
public enum VdWritePolicy {
    WRITE_THROUGH("wt", "Write Through"),
    WRITE_BACK("wb", "Write Back"),
    ALWAYS_WRITE_BACK("awb", "Always Write Back");

    public static final VdWritePolicy DEFAULT = WRITE_BACK;

    private final String cliToken;
    private final String displayName;

    VdWritePolicy(String cliToken, String displayName) {
