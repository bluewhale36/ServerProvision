 ...
 */
public enum VdReadPolicy {
    READ_AHEAD("ra", "Read Ahead"),
    NO_READ_AHEAD("nora", "No Read Ahead");

    public static final VdReadPolicy DEFAULT = READ_AHEAD;

    private final String cliToken;
    private final String displayName;

    VdReadPolicy(String cliToken, String displayName) {
