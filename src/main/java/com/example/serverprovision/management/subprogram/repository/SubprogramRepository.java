...
public interface SubprogramRepository extends JpaRepository<Subprogram, Long> {
    ...
    @Query("""
            ...
            """)
    Optional<Subprogram> findActiveByBoardKey(@Param("kind") SubprogramKind kind,
    ...
    @Query("""
            ...
            """)
    Optional<Subprogram> findSoftDeletedByBoardKey(@Param("kind") SubprogramKind kind,
                                                   @Param("boardId") Long boardId,
                                                   @Param("name") String name,
                                                   @Param("version") String version);
    ...
    @Query("""
            ...
            where s.kind = :kind
              ...
              and s.isDeleted = false
            """)
    Optional<Subprogram> findActiveByCommonKey(@Param("kind") SubprogramKind kind,
                                               @Param("name") String name,
                                               @Param("version") String version);
    ...
    @Query("""
            ...
            where s.kind = :kind
              ...
              and s.isDeleted = true
            """)
    Optional<Subprogram> findSoftDeletedByCommonKey(@Param("kind") SubprogramKind kind,
                                                    @Param("name") String name,
                                                    @Param("version") String version);
    ...
    @Query("""
            ...
            """)
    List<Subprogram> findByKindAndBoardId(@Param("kind") SubprogramKind kind,
                                          @Param("boardId") Long boardId);
    ...
    @Query("""
            ...
            where s.kind = :kind
              ...
              and s.isDeleted = true
            """)
    Optional<Subprogram> findSoftDeletedConflictCandidate(@Param("kind") SubprogramKind kind,
                                                         @Param("boardId") Long boardId,
                                                         @Param("name") String name,
                                                         @Param("version") String version);
    ...
    @Query("""
            ...
            where s.kind = :kind
              ...
              and s.isDeleted = false
            """)
    boolean existsActiveMatchingKey(@Param("kind") SubprogramKind kind,
                                    @Param("boardId") Long boardId,
                                    @Param("name") String name,
                                    @Param("version") String version);
}
