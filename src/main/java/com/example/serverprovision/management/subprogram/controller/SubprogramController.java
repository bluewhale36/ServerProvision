...
public class SubprogramController {
    ...
    @GetMapping("/new")
    public String newForm(@RequestParam(name = "kind") SubprogramKind kind,
    ...
    public String editForm(@PathVariable("id") Long id, Model model) {
        ...
        model.addAttribute("subprogramForm", new SubprogramUpdateRequest(
                sp.name(),
                sp.version(),
    ...
    @GetMapping("/items")
    @ResponseBody
    public BoardWithSubprogramListResponse items(@RequestParam("kind") SubprogramKind kind,
    ...
    @ResponseBody
    public ResponseEntity<?> intent(@PathVariable("kind") String kindToken,
    ...
    @ResponseBody
    public ResponseEntity<?> uploadBundle(@PathVariable("kind") String kindToken,
                                          @PathVariable("boardScope") String boardScopeToken,
