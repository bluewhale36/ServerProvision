...
/**
 * MK2 WAVE 1 — OSMetadata 신규 등록에서 동일 (OSName, osVersion) 이 soft-deleted / deprecated 상태로
 ...
 */
public class OSMetadataNudgeRequiredException extends NudgeRequiredException {

	public OSMetadataNudgeRequiredException(NudgeRequiredResponse payload) {
