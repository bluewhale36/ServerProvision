...
import com.example.serverprovision.management.bmc.dto.request.BmcRankRequest;
...
public class BmcMetadataController {
	...
	public org.springframework.http.ResponseEntity<Void> reorderRanks(
			...
			@RequestBody @jakarta.validation.Valid BmcRankRequest request
	) {
		bmcService.reorderVersionRanks(boardId, request.orderedIds());
