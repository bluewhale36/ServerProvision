...
public class ChildLifecycleBlockedByParentException extends DomainException {
    ...
    public ChildLifecycleBlockedByParentException(ResourceType parentResourceType,
    ...
    private static String composeMessage(String parentDisplayName, String parentState, String requestedAction) {
        ...
        return String.format("부모 자원 '%s' 이(가) %s 상태라 자식의 %s 액션이 거절됐어요. %s",
                parentDisplayName, parentStateKor, requestedAction, suggestion);
    }

    public ResourceType getParentResourceType() { return parentResourceType; }
    public Long getParentResourceId() { return parentResourceId; }
    public String getParentState() { return parentState; }
    public ResourceType getChildResourceType() { return childResourceType; }
    public Long getChildResourceId() { return childResourceId; }
